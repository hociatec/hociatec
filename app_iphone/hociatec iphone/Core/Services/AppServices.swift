...
private struct TradeInService: TradeInServing {
    ...
    func createTradeIn(payload: TradeInRequestPayload, ribFilename: String, ribData: Data, authorized: Bool) async throws -> TradeInSummary { try await api.createTradeIn(payload: payload, ribFilename: ribFilename, ribData: ribData, authorized: authorized) }
}

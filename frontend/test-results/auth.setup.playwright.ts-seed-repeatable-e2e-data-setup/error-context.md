...
- Name: auth.setup.playwright.ts >> seed repeatable e2e data
- Location: e2e/auth.setup.playwright.ts:15:1

# Error details

```
Error: Playwright E2E is blocked unless PLAYWRIGHT_E2E_ALLOWED=1 is set. Use a dedicated environment, then rerun the suite explicitly.
```

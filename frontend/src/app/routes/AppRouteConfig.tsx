...
export const publicRoutes: AppRouteDefinition[] = [
  ...
  { path: '/catalogue/vente', element: <SellingTypePage sellingType="sale" title="Vente" /> },
  {
    ...
    element: <SellingTypePage sellingType="rental" title="Location" />,
  },
  ...
  children: [
      ...
      children: [
        { index: true, element: <Navigate to="categories" replace /> },
        {
          ...
          children: [
            ...
            { path: ':categoryId/edit', element: <CategoryFormPage /> },
          ],
        },
        {
          path: 'brands',
          children: [
            ...
            { path: 'new', element: <BrandFormPage /> },
            { path: ':brandId/edit', element: <BrandFormPage /> },
          ],
        },
        {
          path: 'products',
    ...
    },
    {
      ...
      children: [
        ...
        { path: ':serviceId/edit', element: <ServiceFormPage /> },
      ],
    },
    {
      path: 'orders',
    ...
    },
    {
      path: 'promotions',
      children: [
        { index: true, element: <PromotionsListPage /> },
        { path: 'new', element: <PromotionFormPage /> },
        { path: ':promotionId/edit', element: <PromotionFormPage /> },
      ],
    },
    {
      path: 'vouchers',
      children: [
        { index: true, element: <VouchersPage /> },
        { path: 'new', element: <VoucherFormPage /> },
        { path: ':voucherId/edit', element: <VoucherFormPage /> },
      ],
    },
    {
      path: 'audits',
      children: [
        { index: true, element: <AdminAuditsListPage /> },

        ...
        <PageContainer title="Espace Bêta-Testeur">
          <div className="my-8 max-w-2xl mx-auto rounded-2xl border border-brand-100 bg-white p-8 text-center shadow-lg space-y-4">
            ...
            <p className="text-sm leading-relaxed text-stone-600 max-w-lg mx-auto">
              Votre compte n'est pas encore inscrit au programme de bêta-test. Créez votre profil bêta-testeur pour accéder aux campagnes, tester de nouvelles fonctionnalités et soumettre vos rapports de bugs.
            </p>
      ...
      <PageContainer title="Mon espace bêta">
        ...
        {profile && (
          <section className="mb-8 rounded-lg border border-stone-200 bg-white p-5">
            ...
            <Link className="mt-3 inline-flex underline text-brand-700 hover:text-brand-800 font-medium" to="/beta/profile">
              Modifier mon profil
            </Link>
          </section>
        )}
        ...
        <section>
          ...
          {reports.length === 0 ? (
            <p className="text-stone-600">Aucun signalement pour le moment.</p>
          ) : (

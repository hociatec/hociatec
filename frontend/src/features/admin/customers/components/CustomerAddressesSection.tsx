...
export const CustomerAddressesSection = ({
  ...
  const addressesPagination = useAdminPagination(addresses);
      ...
      {addresses.length === 0 ? (
        ...
        <>
          <div className="grid gap-4 md:grid-cols-2">
            {addressesPagination.paginatedItems.map((address) => (
          ...
          <PaginationControls
            ...
            total={addressesPagination.total}
            totalLabel="adresse"
            totalPages={addressesPagination.totalPages}

                ...
                <tr key={customer.id}>
                  ...
                  <td>
                    <div className="flex flex-wrap gap-3">
                      <Link className="inline-flex items-center text-sm font-semibold underline" to={`/admin/customers/${customer.id}`}>
                        Fiche client
                      </Link>
                      ...
                      <Link className="inline-flex items-center text-sm underline" to={`/admin/customers/${customer.id}?panel=email`}>
                        Email
                      </Link>
                      {customer.phoneNumber ? (
                        <a className="inline-flex items-center text-sm underline" href={`tel:${normalizePhoneLink(customer.phoneNumber)}`}>
                          Appeler
                        </a>
                      ) : null}
                    </div>

    ...
    <section className="rounded-xl border border-brand-100 bg-white p-5 shadow-sm">
      ...
      <div className="grid gap-4 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
        <div className="rounded-2xl border border-brand-100 bg-brand-50 p-4 text-sm text-stone-700">
          ...
          {trackingUrl ? <div className="mt-3"><a className="text-brand-700 underline" href={trackingUrl} target="_blank" rel="noopener noreferrer">Ouvrir le lien de suivi</a></div> : null}
        </div>
        {isEditing ? (

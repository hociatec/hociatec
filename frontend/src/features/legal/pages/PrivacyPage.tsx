...
export const PrivacyPage = () => {
  ...
  useMetaTags({
    ...
    description: 'Informations sur la collecte, l’usage, les bases légales, les durées de conservation et les droits liés aux données personnelles.',
    type: 'article',
  });
      ...
      <div className="container mx-auto max-w-3xl px-4 py-10">
        ...
        <div className="prose prose-stone max-w-none">
          ...
          <p>
            ...
            <strong> hociatec.fr</strong> est <strong>Hociatec</strong>, SARL immatriculée au RCS
            de Nanterre sous le numéro SIREN 934 814 559, dont le siège social est situé au
            2 allée Anatoli Vaisser, 92600 Asnières-sur-Seine, France.
          </p>
          <p>
          ...
          <p>
            ...
            les données contre l’accès non autorisé, la perte, l’altération ou la divulgation. Aucune
            mesure de sécurité n’étant absolue, les utilisateurs sont invités à protéger leurs
          ...
          <p>
            ...
            réclamation auprès de la CNIL: <a href="https://www.cnil.fr" rel="noreferrer" target="_blank">www.cnil.fr</a>.
          </p>

          <h2>12. Cookies</h2>
          <p>
            Le site utilise des cookies techniques nécessaires au fonctionnement, à la sécurité, à la
            session utilisateur, au panier ou à l’authentification. Ces cookies ne nécessitent pas de
            consentement lorsqu’ils sont strictement nécessaires.
          </p>
          <p>

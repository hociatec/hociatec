...
export const MentionsPage = () => {
  ...
  useMetaTags({
    ...
    description: 'Identification de l’éditeur du site Hociatec, hébergement, propriété intellectuelle, données personnelles et contact.',
    type: 'article',
  });
      ...
      <div className="container mx-auto max-w-3xl px-4 py-10">
        ...
        <div className="prose prose-stone max-w-none">
          ...
          <p>
            ...
            société à responsabilité limitée (SARL) au capital social de <strong>1 000 €</strong>.
          </p>
          <p>
          ...
          <p>
            ...
            simplifiée dont le siège social est situé au <strong>2 rue Kellermann, 59100 Roubaix,
            France</strong>.
          </p>
          <p>
            Site web de l’hébergeur: <a href="https://www.ovhcloud.com/fr/" rel="noreferrer" target="_blank">ovhcloud.com</a>.
          </p>
          ...
          <p>
            ...
            totale ou partielle, sans autorisation écrite préalable de Hociatec est interdite,
          ...
          <p>
            ...
            exercer leurs droits en écrivant à <a href="mailto:contact@hociatec.fr">contact@hociatec.fr</a>.
          </p>
          ...
          <p>
            ...
            ne sont pas strictement nécessaires, ne sont déposés qu’avec le consentement préalable de
            l’utilisateur.
          </p>
          ...
          <p>
            ...
            contenu, vous pouvez écrire à <a href="mailto:contact@hociatec.fr">contact@hociatec.fr</a>.
          </p>
        </div>
      </div>
    </SiteLayout>

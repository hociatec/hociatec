...
export const CGV_UPDATED_AT = '20 juillet 2026';

const cgvSections: LegalSectionContent[] = [
  {
  ...
  {
    title: '3. Produits, services et locations',
    body: (
      <>
        <p>
  ...
  {
    title: '8. Livraison et disponibilité',
    body: (
      <>
        <p>
  ...
  {
    title: '10. Droit de rétractation des consommateurs',
    body: (
      <>
        <p>
  ...
  {
    title: '13. Clients professionnels',
    body: (
      <p>
        ...
        maintenance, disponibilité, recette, limitation de responsabilité ou confidentialité. Elles
        figurent le cas échéant dans le devis ou le contrat applicable.
      </p>
    ),
  },
  {
    title: '14. Médiation de la consommation',
    body: (
      <>
        <p>
...
export const cgvContent = renderLegalSections(cgvSections);

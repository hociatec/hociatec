...
final class Version20260815062049 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->dropIndexIfExists('cart_items', 'cart_item_unique_product_period');
        $this->dropIndexIfExists('cart_items', 'cart_item_unique_product_months');
        ...
        $this->addSql('CREATE UNIQUE INDEX cart_item_unique_product_months ON cart_items (cart_id, product_id, selling_type, rental_months)');
        $this->dropIndexIfExists('catalog_products', 'idx_catalog_products_price_publication');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->dropIndexIfExists('catalog_products', 'idx_catalog_products_sale_price_publication');
        $this->dropIndexIfExists('catalog_products', 'idx_catalog_products_rental_price_publication');

...
final class Version20260813223000 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Add address type and professional invoice fields back to shipping addresses without purchase order number';
    }

...
final class Version20260805100000 extends AbstractMigration
{
    ...
    {
        $this->addSql('ALTER TABLE marketing_email_campaigns ADD pending_count INT DEFAULT 0 NOT NULL, ADD sent_count INT DEFAULT 0 NOT NULL, ADD failed_count INT DEFAULT 0 NOT NULL, ADD skipped_count INT DEFAULT 0 NOT NULL');

...
final class Version20251208160000 extends AbstractMigration
{
    ...
    {
        $this->addSql("ALTER TABLE catalog_products ADD reviews_count INT NOT NULL DEFAULT 0, ADD reviews_average DOUBLE PRECISION NOT NULL DEFAULT 0");
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql("ALTER TABLE catalog_products DROP reviews_count, DROP reviews_average");
    }
}

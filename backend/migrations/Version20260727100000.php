...
final class Version20260727100000 extends AbstractMigration
{
    ...
    {
        return 'Create beta profiles, campaigns and bug reports';
    }
    ...
    {
        $this->addSql('DROP TABLE beta_bug_reports');
        $this->addSql('DROP TABLE beta_campaigns');
        $this->addSql('DROP TABLE beta_tester_profiles');
    }
}

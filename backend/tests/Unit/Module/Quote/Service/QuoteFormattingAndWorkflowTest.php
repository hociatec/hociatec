...
final class QuoteFormattingAndWorkflowTest extends TestCase
{
    ...
    public function testFormatQuoteIncludesItemsTotalsCustomerDatesAndConvertedOrder(): void
    {
        ...
        $quote->setConvertedOrderId(77);
        $quote->setConvertedOrderNumber('ORD-2026-001');
        ...
        self::assertSame(77, $payload['convertedOrder']['id']);
    ...
    {
        return new QuoteFormatter(new QuoteCalculator());
    }
}

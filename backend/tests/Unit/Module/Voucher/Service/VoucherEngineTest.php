...
final class VoucherEngineTest extends TestCase
{
    ...
    {
        $repository = $this->createMock(VoucherRepositoryPort::class);
    ...
    {
        $engine = new VoucherEngine($this->createMock(VoucherRepositoryPort::class), new \App\Module\Voucher\Application\Projection\VoucherFormatter());

 ...
 */
final class AuditTemplateDefinitions
{
    /**
    ...
    public static function performanceTemplate(): array
    {
        return [
            'Chargement' => [
    ...
    /** @return array<string, list<array{key: string, label: string}>> */
    public static function securityTemplate(): array
    {
        return [
            'Transport' => [
    ...
    /** @return array<string, list<array{key: string, label: string}>> */
    public static function uxTemplate(): array
    {
        return [
            'Lisibilité' => [
    ...
    /** @return array<string, list<array{key: string, label: string}>> */
    public static function seoTemplate(): array
    {
        return [
            'Indexation' => [
    ...
    /** @return array<string, list<array{key: string, label: string}>> */
    public static function technicalTemplate(): array
    {
        return [
            'Architecture' => [

...
class TrainingSession
{
    ...
    public function getDailyStartTime(): DateTimeImmutable { return $this->dailyStartTime; }
    public function setDailyStartTime(DateTimeImmutable $dailyStartTime): self { $this->dailyStartTime = $dailyStartTime; return $this; }
    public function getDailyEndTime(): DateTimeImmutable { return $this->dailyEndTime; }
    public function setDailyEndTime(DateTimeImmutable $dailyEndTime): self { $this->dailyEndTime = $dailyEndTime; return $this; }
    public function includesWeekends(): bool { return $this->includeWeekends; }
    public function setIncludeWeekends(bool $includeWeekends): self { $this->includeWeekends = $includeWeekends; return $this; }
    public function getLocation(): ?string { return $this->location; }
    public function setLocation(?string $location): self { $this->location = $location; return $this; }
    public function getMeetingUrl(): ?string { return $this->meetingUrl; }
    public function setMeetingUrl(?string $meetingUrl): self { $this->meetingUrl = $meetingUrl; return $this; }

...
final readonly class PrometheusMetricContractProvider
{
    ...
    public function baseLines(int $databaseUp): array
    {
        return [
            ...
            '# HELP hociatec_webhook_failures_total Failed webhook deliveries.',
            '# TYPE hociatec_webhook_failures_total counter',
            ...
            '# HELP hociatec_backup_failed_total Failed database backup runs.',
            '# TYPE hociatec_backup_failed_total counter',

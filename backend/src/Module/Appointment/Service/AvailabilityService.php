...
final class AvailabilityService
{
    ...
    public function getAvailableSlots(DateTimeImmutable $rangeStart, DateTimeImmutable $rangeEnd, Prestation $prestation): array
    {
        ...
        while ($cursor < $rangeEnd) {
            ...
            if ($configuration !== null && $configuration->hasWorkingHours()) {
                $slots = array_merge(
                    $slots,
                    $this->computeSlotsForDay($cursor, $configuration, $appointments, $prestation)
                );
            }
    ...
    /**
     * @param list<\App\Module\Appointment\Entity\Appointment> $appointments
     */
